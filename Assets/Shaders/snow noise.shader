...
Shader "matcap"
{
	Properties
	{
		_practice_kan_snow_i4( "practice_kan_snow_i4", 2D ) = "white" {}
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				uniform sampler2D _practice_kan_snow_i4;
							...
							) : SV_Target
				{
					...
					float2 texCoord5 = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
					float2 appendResult6 = (float2(( texCoord5.x * 10.0 ) , ( texCoord5.y * 10.0 )));
					

					o.Albedo = ( tex2D( _practice_kan_snow_i4, appendResult6 ) * 0.1 ).rgb;
...
ASEEND*/
//CHKSM=BD654D3E64DD25FE13349EE44060794DBA15506B