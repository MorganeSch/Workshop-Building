...
Shader "Custom/Pellet"
{
	Properties
	{
		...
		_re_pellet_kankyou01_i4( "re_pellet_kankyou01_i4", 2D ) = "white" {}
		_re_pellet01_i4d( "re_pellet01_i4d", 2D ) = "white" {}
	...
	SubShader
	{
		...
		uniform float _RED;
		uniform float _BLUE;
		uniform sampler2D _re_pellet01_i4d;
		uniform sampler2D _re_pellet_kankyou01_i4;
		uniform float4 _re_pellet_kankyou01_i4_ST;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 appendResult165 = (float2(1.0 , 1.0));
			float2 uv_TexCoord161 = i.uv_texcoord + appendResult165;
			float2 uv_re_pellet_kankyou01_i4 = i.uv_texcoord * _re_pellet_kankyou01_i4_ST.xy + _re_pellet_kankyou01_i4_ST.zw;
			float4 lerpResult106 = lerp( ( ( 1 == _Is1 ? tex2DNode2 : float4( 0,0,0,0 ) ) + ( 1 == _Is5 ? tex2DNode112 : float4( 0,0,0,0 ) ) + ( 1 == _Is10 ? tex2DNode111 : float4( 0,0,0,0 ) ) + ( 1 == _Is20 ? tex2DNode109 : float4( 0,0,0,0 ) ) ) , ( float4( ifLocalVar122 , 0.0 ) + tex2D( _re_pellet01_i4d, ( uv_TexCoord161 * 1.0 ) ) + tex2D( _re_pellet_kankyou01_i4, uv_re_pellet_kankyou01_i4 ) ) , ( ( 1 == _Is1 ? ( 1.0 - tex2DNode2.a ) : 0.0 ) + ( 1 == _Is5 ? ( 1.0 - tex2DNode112.a ) : 0.0 ) + ( 1 == _Is10 ? ( 1.0 - tex2DNode111.a ) : 0.0 ) + ( 1 == _Is20 ? ( 1.0 - tex2DNode109.a ) : 0.0 ) ));
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;164;-2304,-1376;Inherit;False;Constant;_X;X;14;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;166;-2320,-1264;Inherit;False;Constant;_Y;Y;14;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;165;-2144,-1344;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;152;-912,-624;Inherit;False;228;419;Selection/PseudoBool;5;126;149;150;148;140;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;116;-2368,-1088;Inherit;False;756;880;color ;6;122;121;120;119;118;117;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;161;-1984,-1360;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;162;-1936,-1168;Inherit;False;Constant;_Float3;Float 3;14;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;126;-848,-512;Inherit;False;Property;_Is1;Is1;6;0;Create;True;0;0;0;False;0;False;0;1;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;149;-848,-384;Inherit;False;Property;_Is10;Is10;8;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;150;-848,-320;Inherit;False;Property;_Is20;Is20;9;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;148;-848,-448;Inherit;False;Property;_Is5;Is5;7;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;121;-2128,-784;Inherit;False;Constant;_Color3;Color 0;1;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;118;-2128,-432;Inherit;False;Constant;_Color2;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0,1,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;117;-2128,-608;Inherit;False;Constant;_Color1;Color 0;1;0;Create;True;0;0;0;False;0;False;1,1,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;120;-2064,-848;Inherit;False;Property;_BLUE;BLUE;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;119;-2064,-912;Inherit;False;Property;_RED;RED;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;140;-848,-576;Inherit;False;Constant;_True;True;6;0;Create;True;0;0;0;False;0;False;1;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;163;-1728,-1184;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ConditionalIfNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;122;-1824,-672;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;156;-1520,-1040;Inherit;True;Property;_re_pellet_kankyou01_i4;re_pellet_kankyou01_i4;12;0;Create;True;0;0;0;False;0;False;-1;cc3ff85c071ae8b4193f92fe148fde5a;cc3ff85c071ae8b4193f92fe148fde5a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;160;-1584,-832;Inherit;True;Property;_re_pellet01_i4d;re_pellet01_i4d;13;0;Create;True;0;0;0;False;0;False;-1;4ee7eb29eada52441bf84447e87a41c8;4ee7eb29eada52441bf84447e87a41c8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;159;-1264,-512;Inherit;True;3;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;155;-128,432;Inherit;False;Property;_Metal;Metal;10;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;154;-128,512;Inherit;False;Property;_Smooth;Smooth;11;0;Create;True;0;0;0;False;0;False;0;0.652;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=65F0DFE44F970B36E2FA134557FA8CD04042AFBA